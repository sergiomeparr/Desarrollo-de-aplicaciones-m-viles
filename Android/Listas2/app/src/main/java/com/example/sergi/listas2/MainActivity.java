package com.example.sergi.listas2;
...
public class MainActivity extends Activity {
    ...
    private List<NuevaEntrada> getEntradas() {
        ...
        for(int i = 1; i < 31; i++) {
            datos.add(new NuevaEntrada("Datos de Entrada " + i, "Sergio ESCOM " + i,
                    new GregorianCalendar(2018, 9, i).getTime(), i % 2 == 0 ? R.drawable.icon_1 : R.drawable.icon_2));
        }
        return datos;
    }
}
